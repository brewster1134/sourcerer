RSpec.describe Sourcerer do
  ...
  context 'when a single package is found' do
    before do
      ...
      Sourcerer.install 'package_foo', version: '1.2.3', source: 'bower'
    end
  ...
  context 'when multiple packages are found' do
    ...
    it 'should raise an error' do
      expect{ Sourcerer.install('package_foo', version: '1.2.3', source: :any) }.to raise_error Sourcerer::Error, 'multiple_packages_found package_foo bower, git'
    end
  end
end